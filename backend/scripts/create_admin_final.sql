-- Script SQL final pour créer un utilisateur admin de test
-- Mot de passe : admin123 (hash bcrypt correct)
...
-- Insertion de l'utilisateur admin avec le BON hash bcrypt
INSERT INTO users (
    id,
    email,
    password,
    ...
    'admin_test_001',
    'admin@crm.com',
    '$2b$10$GSLPT/6sKFNLYd.mme5nLegpzcAh3IbK5ClcIoULaIeUiSRh.OHkG', -- admin123 (hash correct)
    'Admin',
    'CRM',
    'admin',
    'agency_default_001',

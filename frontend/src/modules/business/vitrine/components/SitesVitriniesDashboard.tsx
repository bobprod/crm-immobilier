                            ...
                            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-purple-500">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-lg font-bold text-gray-900 truncate">{config?.slug || '—'}</p>
                                    </div>
                                    <span className="text-4xl">🔗</span>
                                </div>
                            </div>
                        ...
                        {config ? (
                            <div className="bg-white rounded-lg shadow p-6">
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${config.isActive ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-yellow-500">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-4xl font-bold text-gray-900">{pages.length - activePages.length}</p>
                                    </div>
                                    <span className="text-4xl">📝</span>
                                </div>
                            </div>
                                ...
                                {pages.sort((a, b) => a.order - b.order).map((page) => (
                                    <div key={page.id} className="bg-white rounded-lg shadow p-4 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <span className={`px-2 py-1 rounded text-xs font-medium ${page.isActive ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}>
                                                {page.isActive ? 'Active' : 'Brouillon'}
                                            </span>
                                            <button
                                                onClick={() => router.push(`/page-builder/edit/${page.id}`)}

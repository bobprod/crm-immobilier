            ...
            {matches.map((match) => (
                <Card key={match.id} className="overflow-hidden">
                    ...
                    <CardFooter className="bg-gray-50 p-2 flex justify-between">
                        ...
                        <div className="flex gap-1">
                            <Button size="sm" variant="outline" className="text-red-600" onClick={() => handleAction(match.id, 'reject')}>
                                <X className="h-4 w-4" />
                            </Button>
                            <Button size="sm" variant="outline" className="text-green-600" onClick={() => handleAction(match.id, 'accept')}>

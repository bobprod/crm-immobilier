...
import { FileText, Download, Calendar, Filter, X, FileSpreadsheet } from 'lucide-react';
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
          <button
            ...
            className={`px-4 py-2 border rounded-lg transition-colors ${selectedPeriodType === 'today'
          ...
          <button
            ...
            className={`px-4 py-2 border rounded-lg transition-colors ${selectedPeriodType === '7days'
                ? 'border-blue-500 bg-blue-50 text-blue-700'
                : 'border-gray-300 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 border rounded-lg transition-colors ${selectedPeriodType === '30days'
                ? 'border-blue-500 bg-blue-50 text-blue-700'
                : 'border-gray-300 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 border rounded-lg transition-colors ${selectedPeriodType === '90days'
                ? 'border-blue-500 bg-blue-50 text-blue-700'
                : 'border-gray-300 hover:bg-gray-50'
              }`}
          >

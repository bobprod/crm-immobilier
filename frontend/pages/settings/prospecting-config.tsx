              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateConfig('scraping', 'maxConcurrent', parseInt(e.target.value))
                    }
        ...
        <Card className="mt-6 border-blue-200 bg-blue-50">
          <CardContent className="pt-6">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-medium text-blue-900 mb-1">À propos des configurations API</h4>
                <p className="text-sm text-blue-800">
                  Ces paramètres contrôlent les intégrations externes pour la prospection
                  automatique. Vous pouvez activer ou désactiver chaque service indépendamment. Les
                  clés API sont stockées de manière sécurisée et ne sont jamais exposées côté
                  client.
                </p>
              </div>
            </div>
